...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/9d3fba81a1907e6c35aaca3e739ca76e.html";
...
var webviewIdentifier = "sketch-select-beyond.webview";
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  webContents.on("close", function (value) {
    browserWindow.close();
  });
...
function getSettings() {
  ...
  var includeEqualLayers = sketch_settings__WEBPACK_IMPORTED_MODULE_1___default.a.settingForKey("includeEqualLayers");
  ...
  sketch_settings__WEBPACK_IMPORTED_MODULE_1___default.a.setSettingForKey("includeEqualLayers", includeEqualLayers);
  ...
  return {
    context: context,
    includeEqualLayers: includeEqualLayers,
...
function getLayers(direction, target, context, includeEqualLayers, ignoreHidden, ignoreLocked, targetFrame, targetParentIds, layer, output) {
  output = output || {
    layers: [],
    ...
    if (children && children.length) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          output = getLayers(direction, target, context, includeEqualLayers, ignoreHidden, ignoreLocked, targetFrame, targetParentIds, child, output);
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
